...
function About() {
  return (
    ...
    <div
      ...
      className="p-1 md:p-4 border rounded-3xl dark:bg-neutral-900 bg-[#171717] border-neutral-800 dark:border-neutral-800  w-1/4 h-1/2 md:h-3/4"
    >
      <Compare
  ...
  <div className="about__text">
    ...
    <h1 className='text-6xl text-bgwhite  mt-12'>Why Us?</h1>
